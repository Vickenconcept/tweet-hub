    ...
    if ($cachedMentions && isset($cachedMentions['data'])) {
        ...
        foreach ($mentionsData as $mention) {
            if (isset($mention->created_at)) {
                $mentionDate = \Carbon\Carbon::parse($mention->created_at);
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
            ...
            <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    ...
                    <p class="text-sm text-gray-500 max-w-xl">Jump straight into the X workflows you use daily. These
                        cards mirror the left navigation so you can reach any surface fast.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                    <button onclick="window.location.href='/daily-post-ideas'"
                        class="group rounded-2xl border border-gray-200 p-5 text-left hover:border-gray-300 transition">
