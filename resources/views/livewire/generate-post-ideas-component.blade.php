<div class="p-6 bg-white rounded-lg shadow-md" x-data="generatePostIdeas()">
    ...
    @if($activeTab === 'generate')
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <button wire:click="generatePostIdeas" 
                ...
                <span wire:loading.remove>Generate Post Ideas</span>
    ...
    @elseif($activeTab === 'generate' && !$loading)
        <div class="text-center py-8 text-gray-500">
            <i class="bx bx-edit text-4xl mb-4"></i>
            <p>Describe what you want to post about to generate creative ideas</p>
        </div>
    @endif
