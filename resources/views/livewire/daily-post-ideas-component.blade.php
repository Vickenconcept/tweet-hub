<div class="" x-data="dailyPostIdeas()">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Daily Post</h2>
            @if ($hasCachedIdeas)
        ...
        <div class="flex gap-2">
            <button wire:click="togglePreferences"
                ...
                <i class="bx bx-cog mr-1"></i> Preferences
            </button>
    ...
    <!-- Preferences Section -->
    @if ($showPreferences)
        <div class="mb-6 p-6 white rounded-xl  shadow-2xl shadow-gray-200">
            <h3 class="text-xl font-semibold text-blue-900 mb-6 flex items-center">
                <i class="bx bx-cog mr-3 text-2xl"></i>Daily Ideas Preferences
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label for="pref-topic" class="block text-sm font-medium text-gray-700 mb-3">Default Topic</label>
                ...
                <div>
                    <label for="pref-niche" class="block text-sm font-medium text-gray-700 mb-3">Default Niche</label>
            ...
            <div class="flex gap-3">
                <button wire:click="updatePreferences" wire:loading.attr="disabled" wire:target="updatePreferences"
                    class="px-6 py-3 bg-gradient-to-r from-blue-400 to-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 disabled:opacity-50 transition-colors flex items-center cursor-pointer">
                ...
                <button wire:click="togglePreferences"
                    class="px-6 py-3 bg-gradient-to-r from-gray-400 to-gray-600 text-white font-medium rounded-xl hover:bg-gray-600 transition-colors cursor-pointer">
                    Cancel
                </button>
            </div>
        </div>
    ...
    @if ($activeTab === 'generate')
        <div class="mb-6 p-6 bg-white rounded-xl shadow-2xl shadow-gray-200">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Current Settings</h3>
                ...
                <button wire:click="togglePreferences"
                    class="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-400 to-blue-600 rounded-xl hover:bg-blue-200 transition-colors flex items-center cursor-pointer shadow-2xl shadow-gray-200">
            ...
            <div class="flex gap-3">
                <button wire:click="generateIdeas" wire:loading.attr="disabled" wire:target="generateIdeas"
                    class="flex-1 px-6 py-3 bg-gradient-to-r from-green-400 to-green-600 text-white font-medium rounded-xl hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center cursor-pointer shadow-2xl shadow-gray-200">
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach ($ideas as $index => $idea)
                    ...
                    @endphp
                    <div
                        class="p-4 rounded-2xl bg-white hover:bg-gray-50 transition-colors shadow-2xl shadow-gray-200">
                        <div class="flex items-start justify-between mb-3">
                            <span
                                class="inline-block w-6 h-6 bg-blue-100 text-blue-600 text-sm font-medium rounded-full text-center">
                                {{ $index + 1 }}
                            </span>
